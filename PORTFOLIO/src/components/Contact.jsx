...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    const mailtoLink = `mailto:dattunayak19s@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(emailBody)}`;

    const templateParams = {
      from_name: name,
      to_email: "dattunayak19s@gmail.com",
      email,
      message,
      reply_to: email,
      subject: "Portfolio Contact Form Submission",
      portfolio_theme: "dark-cyber"
    };
    ...
    emailjs
      ...
      .catch((err) => {
        ...
        toast.error(`Connection failed: ${errorText}`, { autoClose: 8000 });
        toast.info("Opening your email app as a fallback...", { autoClose: 4000 });
      ...
      <AnimatePresence>
        {loaded && currentFrameIdx >= 120 && (
          ...
          >
            ...
            >
              <input type="hidden" name="to_email" value="dattunayak19s@gmail.com" />
